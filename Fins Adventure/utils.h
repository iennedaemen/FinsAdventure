...
#pragma endregion CollisionFunctionality
	...
	void SetVolumeDown(SoundEffect& soundEffect, const int& decrease);
	void SetVolumeDown(SoundStream& soundStream, const int& decrease);
	void SetVolumeUp(SoundEffect& soundEffect, const int& increase);
	void SetVolumeUp(SoundStream& soundStream, const int& increase);
}