...
void utils::SetVolumeDown(SoundEffect& soundEffect, const int& decrease)
{
	soundEffect.SetVolume(soundEffect.GetVolume() - decrease);
}
void utils::SetVolumeDown(SoundStream& soundStream, const int& decrease)
{
	soundStream.SetVolume(soundStream.GetVolume() - decrease);
}

void utils::SetVolumeUp(SoundEffect& soundEffect, const int& increase)
{
	soundEffect.SetVolume(soundEffect.GetVolume() + increase);
}
void utils::SetVolumeUp(SoundStream& soundStream, const int& increase)
{
	soundStream.SetVolume(soundStream.GetVolume() + increase);
}
